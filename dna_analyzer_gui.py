...
class DNAAnalyzerGUI:
    def __init__(self):
        ...
        self.active_figures = []  # Track matplotlib figures for cleanup
    ...
    def on_closing(self):
        """Handle window closing - cleanup extracted data and figures"""
        
        # Close all matplotlib figures to prevent tkinter errors
...
4. Apply insights to race strategy development"""
    ...
    def create_performance_overview_chart(self, parent):
        ...
        # Store figure for export functionality and tracking
...
• Strong correlation between speed and track type"""
    ...
    def update_overview_chart(self):
        ...
        # Clear all existing widgets from viz_frame
    ...
    def update_dashboard_content(self):
        ...
        # Close old dashboard figure if it exists
        if hasattr(self, 'dashboard_fig') and self.dashboard_fig is not None:
            try:
                plt.close(self.dashboard_fig)
                if self.dashboard_fig in self.active_figures:
                    self.active_figures.remove(self.dashboard_fig)
            except:
                pass
        
        # Clear all existing widgets from dashboard content
    ...
    def update_visualization_content(self):
        ...
        # Clear all existing widgets from visualization content
